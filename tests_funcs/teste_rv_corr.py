...
from util_funcs import calc_fits_wv_1d, _get_simbad_data, read_fits, correct_spec_rv, flag_ratio_RV_corr
...
#espetro está muito deslocado para o vermelho entao nao ha compatibilidade com o template mesmo cortando pontos