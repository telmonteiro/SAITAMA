...
from pipeline_functions.general_funcs import (calc_fits_wv_1d, read_fits)
from pipeline_functions.get_spec_funcs import (_get_simbad_data)
...
def get_rv_ccf(star, stellar_wv, stellar_flux, stellar_header, template_hdr, template_spec, drv, units, instrument, quick_RV):
    ...
    try:
        ...
        if instrument == "HARPS":
            ...
            rvmin = rv_simbad - 110; rvmax = rv_simbad + 110
